...
{
	public partial class ExitButton : PositionedObject, IDestroyable, IVisible, IWindow, IClickable
	{
        ...
        public ExitButton(string contentManagerName) :
            this(contentManagerName, true)
        {
        }


        public ExitButton(string contentManagerName, bool addToManagers) :
			base()
		{
			// Don't delete this:
...
// Generated AddToManagers
		...
		public static void LoadStaticContent (string contentManagerName)
		{
			...
			if (LoadedContentManagers.Contains(contentManagerName) == false)
			{
				...
				lock (mLockObject)
				{
					...
					{
						FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("ExitButtonStaticUnload", UnloadStaticContent);
						mRegisteredUnloads.Add(ContentManagerName);
					}
				}
				if (!FlatRedBallServices.IsLoaded<FlatRedBall.Graphics.Animation.AnimationChainList>(@"content/entities/exitbutton/animationchainlistfile.achx", ContentManagerName))
				{
					registerUnload = true;
				}
				AnimationChainListFile = FlatRedBallServices.Load<FlatRedBall.Graphics.Animation.AnimationChainList>(@"content/entities/exitbutton/animationchainlistfile.achx", ContentManagerName);
    ...
    // DELEGATE START HERE
		...
		public static class ExitButtonExtensionMethods
	{
		public static void SetVisible (this PositionedObjectList<ExitButton> list, bool value)
		{
